...
class Node:
    ...
    """
    def __init__(self, model, path: Union[tuple, str]):
...
class Model:
    ...
    def _node(self, identifier: Union[tuple, str]) -> Node:
    ...
    def create(self, group: Union[Node, tuple, str], *arguments, name=None):
        """
    ...
    def property(self, node: Union[Node, tuple, str], name, value=None):
        """
